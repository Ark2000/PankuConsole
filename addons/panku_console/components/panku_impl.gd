...
func remove_env(env_name:String):
	...
	output("[color=green][Info][/color] [b]%s[/b] env unloaded!"%env_name)
...
func _ready():
	...
	output("[color=burlywood][b][color=burlywood]Version 1.0.1 (b7c302)[/color][/b][/color]")
	...
	output("[color=burlywood][b]For more info, please visit: [color=green][url=https://www.github.com]project github page[/url][/color][/b][/color]")
	output("")
	...
	register_env("default", $DefaultEnv)
